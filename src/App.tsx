...
const OrganizationFinance = lazyRetry(() => import("@/pages/organization-finance/index"));
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/organization-finance">{() => <ProtectedRoute component={OrganizationFinance} />}</Route>
