import { defineConfig, loadEnv } from "vite";
  ...
  // Use Latest-Coopvest Render API server for backend calls - points to /api/v2/admin endpoints
  const apiBaseUrl = env.VITE_API_BASE_URL || 'https://coopvest-api.onrender.com/api/v2/admin';
